...
%changelog
* Thu Jul 24 2025 Martin Pitt <mpitt@redhat.com> - 328.2-1
- Don't crash if parent of a host device is missing (RHEL-105065)
- Allow managing source mode of directly attached network interfaces (RHEL-105068)
